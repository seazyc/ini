const fs = require('fs')
const uang = JSON.parse(fs.readFileSync('./src/rpg/uang.json'))
const ikan = JSON.parse(fs.readFileSync('./src/rpg/ikan.json'))
const planet = JSON.parse(fs.readFileSync('./src/rpg/planet.json'))
const coal = JSON.parse(fs.readFileSync('./src/rpg/coal.json'))
const stone = JSON.parse(fs.readFileSync('./src/rpg/stone.json'))
const ore = JSON.parse(fs.readFileSync('./src/rpg/ore.json'))
const ingot = JSON.parse(fs.readFileSync('./src/rpg/ingot.json'))
const kayu = JSON.parse(fs.readFileSync('./src/rpg/kayu.json'))
const _level = JSON.parse(fs.readFileSync('./src/rpg/level.json'))
let besiAwal = 15;
  let goldAwal = 10;
  let emeraldAwal = 5;
  let umpanAwal = 5;
...
let _RPG = JSON.parse(fs.readFileSync('./src/rpg/inventory.json'))
...
const addLevelingXp = (sender, amount) => {
	...
	if (position !== false) {
		...
		fs.writeFileSync('./src/rpg/level.json', JSON.stringify(_level))
	}
}
...
const addATM = (sender) => {
	...
	uang.push(objo)
	fs.writeFileSync('./src/rpg/uang.json', JSON.stringify(uang))
}
...
const addIkan = (sender, amount) => {
    	...
    	fs.writeFileSync('./src/rpg/ikan.json', JSON.stringify(ikan))
    	}
    }
...
const addPlanet = (sender, amount) => {
    	...
    	fs.writeFileSync('./src/rpg/planet.json', JSON.stringify(planet))
    	}
    }
...
const jualbahankimia = (sender, amount) => {
 ...
 const addCoal = (sender, amount) => {
    	...
    	fs.writeFileSync('./src/rpg/coal.json', JSON.stringify(coal))
    	}
    }
...
const addStone = (sender, amount) => {
    	...
    	fs.writeFileSync('./src/rpg/stone.json', JSON.stringify(stone))
    	}
    }
...
const addOre = (sender, amount) => {
    	...
    	fs.writeFileSync('./src/rpg/ore.json', JSON.stringify(ore))
    	}
    }
...
const jualore = (sender, amount) => {
        ...
        if (position !== false) {
            ore[position].copperore -= amount
            fs.writeFileSync('./src/rpg/ingot.json', JSON.stringify(ingot))
        }
    }
...
const addKayu = (sender, amount) => {
    	...
    	fs.writeFileSync('./src/rpg/kayu.json', JSON.stringify(kayu))
    	}
    }
...
const addInventori = (sender) => {
            ...
            _RPG.push(obj)
            fs.writeFileSync('./src/rpg/inventory.json', JSON.stringify(_RPG))
        } 
